...
export class Initial1684061333683 implements MigrationInterface {
    name = 'Initial1684061333683'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "payments" ("id" BIGSERIAL NOT NULL, "sum" integer NOT NULL, "timestamp" TIMESTAMP NOT NULL DEFAULT now(), "meter_serial" character(8) NOT NULL, CONSTRAINT "PK_197ab7af18c93fbb0c9b28b4a59" PRIMARY KEY ("id"))`);
